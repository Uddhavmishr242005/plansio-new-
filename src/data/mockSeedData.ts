...
export const INITIAL_CATEGORIES: Category[] = [
  {
    ...
    name: 'Indoor Plants',
    slug: 'indoor-plants',
    description: 'Air-purifying, lush living greens tailored for living rooms, bedrooms, and office desks.',
  ...
  },
  {
    ...
    name: 'Outdoor Plants',
    slug: 'outdoor-plants',
    description: 'Sun-loving flowering perennials, palms, and balcony greenery built to thrive outdoor.',
  ...
  },
  {
    ...
    name: 'Pots & Planters',
    slug: 'pots-planters',
    description: 'Textured ceramic planters, terracotta pots, fluted vessels, and decorative plant stands.',
  ...
  },
  {
    ...
    name: 'Vermicompost',
    slug: 'vermicompost',
    description: '100% pure organic earthworm castings fortified with bio-enzymes, mycorrhizae and soil microbes.',
  ...
  },
  {
    ...
    name: 'Seeds & Soil',
    slug: 'seeds-soil',
    description: '100% organic vermicompost, nutrient-rich potting mixes, coco peat, and heirloom seeds.',
    image_url: 'https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?auto=format&fit=crop&w=600&q=80',
    is_active: true,
    product_count: 7,
    created_at: '2026-01-01T00:00:00Z',
  },
  {
    ...
    name: 'Plant Care',
    slug: 'plant-care',
    description: 'Vintage brass watering cans, organic neem boosters, pruning shears, and care essentials.',
  ...
  },
  {
    ...
    name: 'Gift Cards',
    slug: 'gift-cards',
    description: 'Instant botanical e-gift vouchers for plant lovers, friends, family, and home warming.',
